saturamPiperrApp = function () {
    ...
    function save_source_configuration() {
        let int_id = $('div[class="brand-card brand-db-card active"]').find('input[name="integration_id"]').val();
        ...
        if (global_source_list.length != 0) {        
            ...
            for (let i = 0; i < data0.length; i++) {
                ...
                <option value="30">30</option> \
                    ...
                    <div class="col-md-6"><label class="control-label" style="text-transform: capitalize;"><strong>' + val + '</strong></label></div>\
                    <input id="int_id" style="display:none" name="integration_id" value="' +val1 + '"> </input> \
                    <input id="filter_param" style="display:none" name="filter_param" value="' + filter_param + '"></input> \
                    <input id="search_user" style="display:none" name="search_user" value="' + search_user + '"> </input> \
                    <input id="search_term" style="display:none" name="search_term" value="' + search_term + '"> </input> \
                    ...
                    for(var j1=0;j1<schema_list.length;j1++){
                        ...
                        <div class="col-md-3"><br/><label class="form-label"><strong>' + schema_list[j1] + '</strong></label> \
                        ...
                        <option value="once">once</option><option value="daily">daily</option><option value="hourly">hourly</option> \
                        ...
                        for(var rIdx=0;rIdx<table_result.length;rIdx++){
                            ...
                            <div class="col-md-3"><br/><label class="form-label"><strong>' + tableName + '</strong>\
                            </label></div>\
                             <div class="col-md-3"><label class="control-label text-light"><span>Refresh Type</span></label> \
