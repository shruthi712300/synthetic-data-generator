...
const DatabaseSelection = () => {
  ...
  const sourceDatabases = [
    ...
    { id: 4, name: 'Production Customer Profiles DB', status: 'CONNECTED', type: 'MongoDB' },
    { id: 5, name: 'Production Brokers DB', status: 'CONNECTED', type: 'Microsoft SQL Server' },
    { id: 6, name: 'Production Data Warehouse', status: 'CONNECTED', type: 'Presto' },
    { id: 7, name: 'Production Web & Mobile App User Activity', status: 'CONNECTED', type: 'Google Analytics' }
  ];
  ...
  const destinationDatabases = [
    ...
    { id: 4, name: 'Development Customer Profiles DB', status: 'READY', type: 'MongoDB' },
    { id: 5, name: 'Development Brokers DB', status: 'READY', type: 'Microsoft SQL Server' },
    { id: 6, name: 'Staging Data Warehouse', status: 'READY', type: 'Presto' },
    { id: 7, name: 'QA Web & Mobile App User Activity', status: 'READY', type: 'Google Analytics' }
  ];
  ...
  return (
    <div className="database-selection-container">
      ...
      <div className="database-grid">
        ...
        <div className="database-column">
          <h3>Destination Database (Dev/QA/Staging)</h3>
          <div className="database-cards">
